...
<footer id="colophon" class="site-footer pt-16 pb-8 md:pb-16 bg-primary-800" role="contentinfo">
	...
	<div class="flex flex-col items-center narrow-container">
		<p class="font-zh text-4xl text-primary-200">山</p>
		<a href="/"
		   class="uppercase tracking-[.25em] text-primary-200 text-sm sm:text-lg mt-1.5"><?php echo get_bloginfo( 'name' ); ?></a>
